...
export const metadata: Metadata = {
  title: "Next.js Buttons | DevDoz Portal - Next.js Dashboard Template",
  description:
    "This is Next.js Buttons page for DevDoz Portal - Next.js Tailwind CSS Admin Dashboard Template",
};
