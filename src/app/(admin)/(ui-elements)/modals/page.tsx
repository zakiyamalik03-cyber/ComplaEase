...
export const metadata: Metadata = {
  title: "Next.js Modals | DevDoz Portal - Next.js Dashboard Template",
  description:
    "This is Next.js Modals page for DevDoz Portal - Next.js Tailwind CSS Admin Dashboard Template",
  // other metadata
};
