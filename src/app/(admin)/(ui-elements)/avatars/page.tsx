...
export const metadata: Metadata = {
  title: "Next.js Avatars | DevDoz Portal - Next.js Dashboard Template",
  description:
    "This is Next.js Avatars page for DevDoz Portal - Next.js Tailwind CSS Admin Dashboard Template",
};
