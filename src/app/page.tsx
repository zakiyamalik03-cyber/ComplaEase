                ...
                <div className="container mx-auto px-4 md:px-6 relative z-10">
                    <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
                        ...
                        <div className="lg:w-1/2 relative">
                            <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 aspect-video lg:aspect-square flex flex-col">
                                ...
                                {/* Mock Content */}
                                <div className="p-6 flex-1 bg-gray-50 dark:bg-gray-800/50 relative overflow-hidden group">
                                    <div className="absolute top-10 left-10 right-10 bottom-10 bg-white dark:bg-gray-900 rounded-xl shadow-sm p-6 border border-gray-200 dark:border-gray-700 transition-transform group-hover:scale-[1.02]">
                                        <div className="flex items-center gap-4 mb-6">
                                            ...
                                            <div>
                                                <div className="h-4 w-32 bg-gray-100 dark:bg-gray-800 rounded mb-2"></div>
                                                <div className="h-3 w-20 bg-gray-100 dark:bg-gray-800 rounded"></div>
                                            </div>
                                        </div>
                                        <div className="space-y-4">
                                            <div className="flex gap-4">
                                                <div className="flex-1 h-24 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-100 dark:border-blue-900/30"></div>
                                                <div className="flex-1 h-24 bg-purple-50 dark:bg-purple-900/20 rounded-lg border border-purple-100 dark:border-purple-900/30"></div>
                                            </div>
                                    ...
                                    <div className="absolute -right-8 top-20 bg-white dark:bg-gray-800 p-4 rounded-lg shadow-xl border border-gray-100 dark:border-gray-700 transform rotate-6 animate-pulse">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                <p className="text-xs font-bold text-gray-900 dark:text-white">Complaint Resolved</p>
