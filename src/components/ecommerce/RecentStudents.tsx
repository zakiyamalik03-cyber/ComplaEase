...
interface Student {
  ...
  year: string; // Year/Level (e.g., "1st Year", "2nd Year")
  gpa: string; // GPA (as a string)
  image: string; // URL or path to the student image
  status: "Excellent" | "Good" | "Average"; // Status of the student
}
