...
export const metadata: Metadata = {
  title: "Next.js Badge | DevDoz Portal - Next.js Dashboard Template",
  description:
    "This is Next.js Badge page for DevDoz Portal - Next.js Tailwind CSS Admin Dashboard Template",
  // other metadata
};
